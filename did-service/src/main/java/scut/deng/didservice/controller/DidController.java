...
public class DidController {
  ...
  @Autowired public DidDocService docService;
  @Resource(name = "VCdict") public Dict VCdict;

  @RequestMapping(value = "/create")
  public BaseResponse
  createDID(@RequestParam(value = "type", defaultValue = "user") String type,
            @RequestParam(value = "comment", defaultValue = "默认评论")
  ...
  @GetMapping("applyVP")
  public BaseResponse applyVP(@RequestParam("uuid") String uuid,
